      ...
      clientBundlePlugin(
        {
          ...
          plugins: [
            ...
            replace({
              ...
              'process.env.SUPABASE_URL': JSON.stringify('https://rcikfjxlmetxjezmoofr.supabase.co'),
              'process.env.SUPABASE_KEY': JSON.stringify('sb_publishable_V4E-b9l25JuVBRityKydcg_0Wksgfru'),
            }),
            entryDataPlugin(),
